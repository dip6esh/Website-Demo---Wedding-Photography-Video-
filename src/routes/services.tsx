...
function ServicesPage() {
  return (
    <main>
      <section className="border-b border-foreground/15"><div className="mx-auto max-w-6xl px-5 py-14 md:py-20"><p className="mb-5 font-mono text-[11px] uppercase tracking-[0.22em] text-primary">Services</p><h1 className="max-w-[13ch] font-display text-5xl font-bold leading-[0.98] md:text-7xl">Our Services</h1><p className="mt-7 max-w-[45ch] text-base leading-relaxed text-foreground/70">From a full wedding weekend to a single product frame, we bring the same care: thoughtful direction, beautiful light, and a finish that lasts.</p></div></section>
